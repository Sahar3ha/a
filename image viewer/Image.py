...
image_no_1 = ImageTk.PhotoImage(Image.open("image viewer/1.png"))
image_no_2 = ImageTk.PhotoImage(Image.open("image viewer/2.png"))
image_no_3 = ImageTk.PhotoImage(Image.open("image viewer/3.png"))
image_no_4 = ImageTk.PhotoImage(Image.open("image viewer/4.png"))
